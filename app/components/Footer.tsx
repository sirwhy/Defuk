    ...
    <footer className="border-t border-white/[0.06] bg-[#0a0a0f]">
      <div className="container py-16">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="text-[rgba(248,250,252,0.5)] text-sm leading-relaxed">
              Create, collect, and trade unique digital assets on the blockchain.
            </p>
          </div>
          ...
          {Object.entries(footerLinks).map(([title, links]) => (
            <div key={title}>
              <h4 className="font-semibold mb-4 text-sm uppercase tracking-wider text-[rgba(248,250,252,0.4)]">
                {title}
              </h4>
              <ul className="space-y-3">
                {links.map((link) => (
                  <li key={link.href + link.label}>
                    <Link 
                      href={link.href}
                      className="text-[rgba(248,250,252,0.6)] hover:text-white transition-colors text-sm"
                    >
                      {link.label}
                    </Link>
                  </li>
        ...
        <div className="mt-12 pt-8 border-t border-white/[0.06] flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-[rgba(248,250,252,0.4)] text-sm">
            © {new Date().getFullYear()} NFTCreate. All rights reserved.
          </p>
          <div className="flex items-center gap-4">
            <a href="#" className="text-[rgba(248,250,252,0.4)] hover:text-white transition-colors">
